...
@section('title', 'Create Property - Hoonian Admin')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="e.g. Grand City Home" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Price (IDR) <span class="text-danger">*</span></label>
                                        <input type="number" name="price" class="form-control" placeholder="e.g. 500000000"
                                            required>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="thumbnailPreview" src="https://via.placeholder.com/150"
                                            class="mt-2 rounded img-thumbnail" style="max-height: 150px; display: none;">
                                    </div>
