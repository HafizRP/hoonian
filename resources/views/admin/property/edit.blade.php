...
@section('title', 'Edit Property - Hoonian Admin')
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="land_area" class="form-control"
                                                    value="{{ old('land_area', $property->land_area) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="building_area" class="form-control"
                                                    value="{{ old('building_area', $property->building_area) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="maps_url" class="form-control"
                                            value="{{ old('maps_url', $property->maps_url) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-2">
                                            @if($property->thumbnail)
                                                <img src="{{ asset($property->thumbnail) }}" alt="Current Thumbnail"
                                        ...
                                        <img id="thumbnailPreview" src="#" class="mt-2 rounded img-thumbnail"
                                        ...
                                        <div class="row mb-2">
                                            @foreach($property->gallery as $gal)
                                                <div class="col-3 mb-2">
                                                    <img src="{{ asset($gal->url) }}" class="img-thumbnail w-100"
